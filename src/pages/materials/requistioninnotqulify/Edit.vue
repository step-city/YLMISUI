             ...
             get () {
                 return {
                     mapconf: [   
                                ...
                                { prop: 'itemDataId', isplace: true, defaultval:'',selprop: 'itemId' }, //来源ID
                                { prop: 'itemDataType', isplace: false, defaultval:'1',selprop: '' },  //来源类型  // 0 常用材料库 1 进料登记选材 2 从总需用计划选材  3 进料登记（30进料登记PDA选材 31发料登记选材 32内部调拨登记选材 33外部调拨登记选材 ）4从磅单选材 5 合同选材 6从库存选材     
                                { prop: 'guid', isplace: false, defaultval:this.newGuid(),selprop: '' },  //临时ID唯一键
                                { prop: 'id', isplace: false,defaultval:'', selprop:'itemId',  },   
                                ...
                                { prop: 'quantity', isplace: true,defaultval:'0', selprop:'storeNum',  },   
    ...
    methods:{
        ...
        _getCurrentNodeOrg(date){
         ...
         _onSelect(){
             //打开选材框的权限判断
             this.fltInfo={
                supplierId:this.formModel.order.supplierId,
